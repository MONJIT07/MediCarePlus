...
const Navbar = () => {
    ...
    // when user signed in, fetch a token and save in to the local storage
    useEffect(() => {
        let mounted = true;
    ...
    }, [authLoaded, getToken, isSignedIn, userLoaded]);
                    ...
                    <div className={ns.centerNavContainer}>
                        <div className={ns.glowEffect}>   
                            <div className={ns.centerNavInner}>
                                ...
                                >
                                    <CenterNavItem to="/dashboard" label="Dashboard" icon={<Home size={16} />} />
                ...
                {open && (
                    <div className={ns.mobileMenuContainer} id="mobile-menu">
                        <div className={ns.mobileMenuInner}>
                            <MobileItem to="/dashboard" label="Dashboard" icon={<Home size={16} />} onClick={() => setOpen(false)} />
